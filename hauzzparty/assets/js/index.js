...
const home__message = document.getElementsByClassName('home__message');
...
main__timeline.from(welcome__img, 2, {
                                        xPercent: '100',
                                        opacity: 0,
                                        boxShadow: '70vw 50px 0px 15px rgb(255,220,163)',
                                        ease: "power2.out"
                                     }, '-=1.5');

main__timeline.from(home__buttonDark, 2, {xPercent: '-100', opacity: 0, ease: "power2.out"}, '-=2');
main__timeline.from(home__buttonLight, 2, {xPercent: '100', opacity: 0, ease: "power2.out"}, '-=2');

main__timeline.from(home__message, 2, {yPercent: '100', opacity: 0, ease: "power2.out"}, '-=1');
